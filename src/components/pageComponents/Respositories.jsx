    ...
    projects: [
      {
        name: "HealthCare",
        description:
          "HealthHub is a basic placeholder healthcare webpage built using HTML, Bootstrap5 and SCSS. This initiative offers a fundamental blueprint for individuals aspiring to construct a simple healthcare website with a responsive layout and refined styling.",
      ...
      },
      {
        name: "Form",
        description:
          "Form web page page built using HTML,css,Bootstrap5,SCSS,jquery. This initiative offers a fundamental blueprint for individuals aspiring to construct a simple healthcare website with a responsive layout and refined styling.",
      ...
      },
      {
        name: "Marketing",
        description:
          "Marketing is a basic placeholder Marketing webpage built using HTML, Bootstrap, and SCSS. This initiative offers a fundamental blueprint for individuals aspiring to construct a simple healthcare website with a responsive layout and refined styling.",
      ...
      },
      {
        name: "CRUD With API",
        description:
          "ReactJs CRUD Application webpage built using HTML, Bootstrap, SCSS ,ReactJs. This initiative offers a fundamental blueprint for individuals aspiring to construct a simple healthcare website with a responsive layout and refined styling.",
      ...
      },
      {
        name: "CONTACT FORM",
        description:
          "Contact Form webpage built using HTML, Bootstrap, SCSS ,Javascript. This initiative offers a fundamental blueprint for individuals aspiring to construct a simple healthcare website with a responsive layout and refined styling.",
